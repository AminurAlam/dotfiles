...
complete -c starship -n "__fish_use_subcommand" -f -a "config-schema" -d 'Generate a schema for the starship configuration as JSON-schema'
...
complete -c starship -n "__fish_seen_subcommand_from config-schema" -s h -l help -d 'Print help information'

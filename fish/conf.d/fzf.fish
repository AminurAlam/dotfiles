...
--scroll-off 4 --border=rounded --ellipsis … --cycle --height 90% --preview-window=right:70% \
--color=spinner:$color0C,hl:$color0D,fg:$color04,header:$color0D,info:$color0A \
--color=pointer:$color0C,marker:$color0C,fg+:$color06,prompt:$color0A,hl+:$color0D"

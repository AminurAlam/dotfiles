...
syn keyword Function CDTEXTFILE CATALOG ISRC TITLE PERFORMER SONGWRITER COMPOSER GENRE DATE DISCID COMMENT LABEL FORMAT URL DISCNUMBER TOTALDISCS REPLAYGAIN_ALBUM_GAIN REPLAYGAIN_ALBUM_PEAK REPLAYGAIN_TRACK_GAIN REPLAYGAIN_TRACK_PEAK

syn match Number /\v [+-]=\d+\.=\d*( |$)/
syn match Number /\v\d+:\d+:\d+( |$)/

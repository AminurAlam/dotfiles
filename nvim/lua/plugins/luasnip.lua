...
M.config = function()
  ...
  ls.add_snippets('fish', {
    ...
    ls.snippet("df", { t [[df -hx tmpfs]] }),
    ls.snippet("pi", { t [[yay -S]] }),
    ls.snippet("pr", { t [[yay -Rs]] }),
    ls.snippet("pu", { t [[yay -Syu]] }),
    ls.snippet("pf", { t [[yay -Ss]] }),
    ls.snippet("pa", { t [[yay -Si]] }),

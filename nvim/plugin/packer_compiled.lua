...
_G.packer_plugins = {
  ...
  ["nvim-docs-view"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/data/data/com.termux/files/home/.local/share/nvim/site/pack/packer/opt/nvim-docs-view",
  ...
  ["nvim-retrail"] = {
    config = { "\27LJ\2\2K\0\0\2\0\4\0\a6\0\0\0'\1\1\0B\0\2\0029\0\2\0005\1\3\0B\0\2\1K\0\1\0\1\0\1\fhlgroup\vSearch\nsetup\fretrail\frequire\0" },
    loaded = true,

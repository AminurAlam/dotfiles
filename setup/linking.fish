...
for config in alacritty aria2 btop clangd dunst eza fish gallery-dl gdb git htop hypr keepassxc lazygit mgba mpv newsboat npm nvim python ruff streamrip termux tmux waybar wofi yay yazi yt-dlp zathura zellij
